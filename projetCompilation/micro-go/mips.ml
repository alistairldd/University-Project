...
let sle  r1 r2 r3  = 
    S(sprintf "  slt  %s, %s, %s" r1 r3 r2 )    (* r1 = (r3 < r2) = (r2 >= r3) *)
    @@ S(sprintf " xori %s, %s, 1" r1 r1)       (* inverse le résultat *)


let sgt  r1 r2 r3  = S(sprintf "  slt  %s, %s, %s" r1 r3 r2 ) (* r1 = (r3 < r2) = (r2 > r3) *)

let sge  r1 r2 r3  = 
    S(sprintf "  slt  %s, %s, %s" r1 r2 r3 )    (* r1 = (r2 < r3) *)
    @@ S(sprintf "  xori %s, %s, 1" r1 r1)      (* inverse : r1 = (r2 > r3) *)


let seq  r1 r2 r3  = 
    S(sprintf "  seq  %s, %s, %s" r1 r2 r3 )    (* r1 = r2 ^ r3 *)
    @@ S(sprintf "  sltiu %s, %s, 1" r1 r1 )    (* r1 = (r1 == 0) *)


let sne  r1 r2 r3  = 
    S(sprintf "  sne  %s, %s, %s" r1 r2 r3 )    (* r1 = r2 ^ r3*)
    @@ S(sprintf "  sltu  %s, $zero, %s" r1 r1) (* r1 = (0 < r1) *)


let and_ r1 r2 r3  = S(sprintf "  and  %s, %s, %s" r1 r2 r3 )
let or_  r1 r2 r3  = S(sprintf "  or   %s, %s, %s" r1 r2 r3 )
let neg  r1 r2     = S(sprintf "  sub  %s, $zero, %s" r1 r2 ) (* r1 = -r2*)

let not_ r1 r2     = S(sprintf "  nor  %s, %s, $zero" r1 r2 ) (* NOT r2 = r2 NOR 0*)
